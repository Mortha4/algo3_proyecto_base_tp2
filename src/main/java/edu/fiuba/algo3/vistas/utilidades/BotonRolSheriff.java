...
public class BotonRolSheriff extends StackPane {
    public BotonRolSheriff(){

        Image imgPergamino = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/rolSheriff.png")));
